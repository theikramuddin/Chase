  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'move-from-left-rotate': 'move-from-left-rotate 1s ease-out forwards',
        'move-from-left': 'move-from-left 1s ease-out forwards',
        'move-from-right': 'move-from-right 1s ease-out forwards',
        'move-to-right': 'move-to-right 1s ease-out forwards',
